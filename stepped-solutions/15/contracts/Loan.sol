...
contract Loan is Ownable, DSMath {
    ...
    event TokenPrice(address tokenAdress, uint price);
    ...
    function setTokenPrice(address _tokenAddress, uint _price) public onlyOwner {
     tokenPrices[_tokenAddress] = _price;
        emit TokenPrice(_tokenAddress, _price);
    }
